...
void WahPedalBoosterFrame::activate(QObject& stomp)
{
  ...
  if(mpStomp != nullptr)
  {
    connect(mpStomp, &Stomp::volumeReceived, this, &WahPedalBoosterFrame::onVolume);
    connect(mpStomp, &Stomp::wahRangeReceived, this, &WahPedalBoosterFrame::onPedalRange);
...
void WahPedalBoosterFrame::deactivate()
{
  if(mpStomp != nullptr)
  {
    disconnect(mpStomp, &Stomp::volumeReceived, this, &WahPedalBoosterFrame::onVolume);
    disconnect(mpStomp, &Stomp::wahRangeReceived, this, &WahPedalBoosterFrame::onPedalRange);
    mpStomp = nullptr;
  }
}
